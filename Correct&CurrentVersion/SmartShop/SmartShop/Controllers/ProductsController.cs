...
namespace SmartShop.Controllers
{
    ...
    {
        // GET: api/BuyingProducts
        [System.Web.Http.Route("api/BuyingProducts")]
        public HttpResponseMessage GetBuyingProducts()
        {
            ...
            var prod = Db.Products.Where(x =>x.ProductStatus == "True" &&x.ProductQuantity>0);
        ...
        public HttpResponseMessage GetProducts()
        {
            ...
            if (admin == "admin@admin.com")
            {
                ...
                prod = Db.Products.Where(x=>x.ProductQuantity>0);
            }
            else
            {
                var currentUser = User.Identity.GetUserId();
                ...
                prod = Db.Products.Where(x =>(( x.UserID == currentUser)&&(x.ProductQuantity>0)));
            }
            return ToJson(prod.AsEnumerable());
        }
